#pragma checksum "D:\Git project\w3schools\Source\w3schools_WEB\Views\LessonContents\AddEditLessonContentsView.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "846bfc01e57b0db52e8b2c64b2be32c2b751fcaa"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"846bfc01e57b0db52e8b2c64b2be32c2b751fcaa", @"/Views/LessonContents/AddEditLessonContentsView.cshtml")]
...
#nullable disable
 ...
 ");
    ...
    function renderEditor(){
      ...
      ");
            ...
            var html = '<div class=""w-100"" id=""Content""><div class=""row"">'+
                '<div class=""p-1 col-sm-12"">'+
                    '<div id = ""btns"" class=""ml-md-5"">'+
                        '<button onclick=""rotate()"" clas");
            WriteLiteral(@"s=""btn mr-2"" id=""rotate"">'+
                ...
                '<div class=""row"">' +
                    ...
                    '<iframe class=");
            WriteLiteral(@"""p-2""name=""targetCode"" id=""targetCode""></iframe>' +
                '</div>' +
                '</div>'+
            '</div>';
            ...
            var header =
                ...
                '<script src=""https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.16.0/umd/popper.m");
    ...
    function saveEdit() {
        var valid = DevExp");
            WriteLiteral(@"ress.validationEngine.validateGroup(""data"");
        if (valid.isValid) {
            if (currContentType == 2) {
            ...
            $.ajax({
                ...
                ""url"": """);
#nullable restore
#line 321 "D:\Git project\w3schools\Source\w3schools_WEB\Views\LessonContents\AddEditLessonContentsView.cshtml"
